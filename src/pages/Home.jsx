...
const NAV_LINKS = ["Home", "About", "Academics", "Admissions", "Departments", "News & Events", "Gallery", "Contact"];
...
const FOOTER_QUICK_LINKS = ["Home", "About", "Academics", "Admissions", "Contact"];
const FOOTER_RESOURCES = ["News & Events", "Gallery", "FAQs", "Student Portal", "Alumni"];
  ...
  return (
    <div className="nu-page">
      ...
      <header className={`nu-nav ${scrolled ? "nu-nav--scrolled" : ""}`}>
        <div className="nu-nav__inner">
          ...
          <nav className="nu-nav__links" aria-label="Primary">
            {NAV_LINKS.map((link) => (
              <a key={link} href="#" className={`nu-nav__link ${link === "Home" ? "is-active" : ""}`}>
                {link}
              </a>
            ))}
          </nav>
          ...
          <div className="nu-nav__actions">
            ...
            <a href="#apply" className="nu-btn nu-btn--primary nu-btn--sm">
              Apply Now
            </a>
      ...
      <div className={`nu-mobile-menu ${menuOpen ? "is-open" : ""}`}>
        ...
        <a href="#apply" className="nu-btn nu-btn--primary nu-mobile-menu__cta" onClick={() => setMenuOpen(false)}>
          Apply Now
        </a>
      </div>
      <button
      ...
      <section className="nu-hero" ref={heroRef}>
        ...
        <div className="nu-hero__inner">
          ...
          <div className="nu-hero__actions nu-anim nu-anim--4">
            <a href="#apply" className="nu-btn nu-btn--primary">
              Apply Now
            </a>
            <a href="#programs" className="nu-btn nu-btn--outline">
      ...
      <section className="nu-legacy">
        <div className="nu-container nu-legacy__grid">
          ...
          <div className="nu-legacy__content">
            ...
            <a href="#about" className="nu-btn nu-btn--primary nu-btn--icon">
      ...
      <section className="nu-programs" id="programs">
        <div className="nu-container">
          <div className="nu-programs__head">
            ...
            <a href="#all-programs" className="nu-btn nu-btn--outline-dark nu-programs__view-all">
              View All Programs
            </a>
          </div>
            ...
            {visiblePrograms.map((program) => (
              <article className="nu-program-card" key={program.title}>
                ...
                <div className="nu-program-card__body">
                  ...
                  <a href="#program" className="nu-link-arrow">
      ...
      <section className="nu-cta" id="apply">
        ...
        <div className="nu-container nu-cta__inner">
          ...
          <div className="nu-cta__actions">
            <a href="#apply-now" className="nu-btn nu-btn--primary">
              Apply Now
            </a>
            <a href="#admissions" className="nu-cta__link">
